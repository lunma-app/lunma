...
| `@inlang/paraglide-js` | 2.x | Compiler-based i18n (devDependency, `catalog:`). Generates `src/shared/paraglide/` (committed, Biome-excluded) via `pnpm gen:i18n`; SW-safe `custom-lunmaSettings` strategy in `src/shared/i18n.ts` |
