...
import { deriveControls } from './catalog/lib/derive-controls';
...
// each story's `controlOverrides`/`excludeControls`.
const uiDir = fileURLToPath(new URL('./src/ui/', import.meta.url));
const derivedEntries = readdirSync(uiDir)
...
const derivedControlsSource = `// AUTO-GENERATED by vite.catalog.config.ts — do not edit by hand.
...
`;
writeFileSync(
  fileURLToPath(new URL('./catalog/lib/derived-controls.generated.ts', import.meta.url)),
  derivedControlsSource,
);
