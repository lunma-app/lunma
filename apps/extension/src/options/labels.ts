...
const SETTING_LABELS: Record<keyof Settings, MessageThunk> = {
  ...
  dedupMovesTabToTop: m.options_label_dedupMovesTabToTop,
  trackTabProvenance: m.options_label_trackTabProvenance,
  closeChildTabsWithParent: m.options_label_closeChildTabsWithParent,
...
const SETTING_DESCRIPTIONS: Record<keyof Settings, MessageThunk> = {
  ...
  dedupMovesTabToTop: m.options_desc_dedupMovesTabToTop,
  trackTabProvenance: m.options_desc_trackTabProvenance,
  closeChildTabsWithParent: m.options_desc_closeChildTabsWithParent,
