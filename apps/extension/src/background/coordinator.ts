  ...
  private buildHandlers(): HandlersMap {
    return {
      ...
      clearTempTabs: async (event) => {
        ...
        this.store.pruneArchivedTabs(now);
        this.dirty = true;
        try {
      ...
      undoClearTempTabs: async (event) => {
        ...
        for (const tabId of tabIds) {
          ...
          await handleRestoreArchivedTab(this.store, {
