...
export const sidebar_clearedtabs1 = /** @type {(inputs: Sidebar_Clearedtabs1Inputs) => LocalizedString} */ (i) => {const countPlural = registry.plural("en", i?.count, {});
...
export const launcher_metaline1 = /** @type {(inputs: Launcher_Metaline1Inputs) => LocalizedString} */ (i) => {const tabPlural = registry.plural("en", i?.tabCount, {});
...
export const launcher_resultstatus1 = /** @type {(inputs: Launcher_Resultstatus1Inputs) => LocalizedString} */ (i) => {const countPlural = registry.plural("en", i?.count, {});
...
export const options_reachused1 = /** @type {(inputs: Options_Reachused1Inputs) => LocalizedString} */ (i) => {const countPlural = registry.plural("en", i?.count, {});
...
export const options_label_showglares1 = /** @type {(inputs: Options_Label_Showglares1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Atmosphere glow`)
};
...
export const options_removeconfirmwarn2 = /** @type {(inputs: Options_Removeconfirmwarn2Inputs) => LocalizedString} */ (i) => {const countPlural = registry.plural("en", i?.count, {});
