...
export const sidebar_clearedtabs1 = /** @type {(inputs: Sidebar_Clearedtabs1Inputs) => LocalizedString} */ (i) => {const countPlural = registry.plural("ru", i?.count, {});
...
export const launcher_metaline1 = /** @type {(inputs: Launcher_Metaline1Inputs) => LocalizedString} */ (i) => {const tabPlural = registry.plural("ru", i?.tabCount, {});
...
export const launcher_resultstatus1 = /** @type {(inputs: Launcher_Resultstatus1Inputs) => LocalizedString} */ (i) => {const countPlural = registry.plural("ru", i?.count, {});
...
export const options_backupexported1 = /** @type {(inputs: Options_Backupexported1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Резервная копия экспортирована`)
};

export const options_backuprestored1 = /** @type {(inputs: Options_Backuprestored1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Резервная копия восстановлена`)
};
...
export const options_reachused1 = /** @type {(inputs: Options_Reachused1Inputs) => LocalizedString} */ (i) => {const countPlural = registry.plural("ru", i?.count, {});
...
export const options_authmethodpublic2 = /** @type {(inputs: Options_Authmethodpublic2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Публично`)
};
...
export const options_grouplabel_tabs1 = /** @type {(inputs: Options_Grouplabel_Tabs1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Вкладки`)
};
...
export const options_label_showglares1 = /** @type {(inputs: Options_Label_Showglares1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Атмосферное свечение`)
};
...
export const launcher_lensinclci2 = /** @type {(inputs: Launcher_Lensinclci2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`вкл. CI`)
};
...
export const options_removeconfirmwarn2 = /** @type {(inputs: Options_Removeconfirmwarn2Inputs) => LocalizedString} */ (i) => {const countPlural = registry.plural("ru", i?.count, {});
