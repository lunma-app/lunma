...
const pt_launcher_resultstatus1 = /** @type {(inputs: Launcher_Resultstatus1Inputs) => LocalizedString} */ (i) => {const countPlural = registry.plural("pt", i?.count, {});
	if (countPlural === "one") return /** @type {LocalizedString} */ (`${i?.count} resultado`);
	if (countPlural === "other") return /** @type {LocalizedString} */ (`${i?.count} resultados`);
	return /** @type {LocalizedString} */ ("launcher_resultStatus");
};
...
const launcher_resultstatus1 = /** @type {((inputs: Launcher_Resultstatus1Inputs, options?: { locale?: "en" | "es" | "pt" | "fr" | "de" | "ja" | "ko" | "zh-CN" | "ru" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Launcher_Resultstatus1Inputs, { locale?: "en" | "es" | "pt" | "fr" | "de" | "ja" | "ko" | "zh-CN" | "ru" }, {}>} */ ((inputs, options = {}) => {
	...
	if (locale === "pt") return pt_launcher_resultstatus1(inputs)
