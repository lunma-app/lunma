...
onMount(() => {
  ...
  const timer = setInterval(() => {
    if (autoplay) select((active + 1) % spaces.length);
  }, 3800);
...
>
  <div class="window">
    ...
    <div class="body">
      ...
      <div class="pageview" aria-label="New tab in this Space">
        <div class="nt-id">
...
<style>
  ...
  .window {
    ...
    background: oklch(0.17 0.008 var(--space-h));
