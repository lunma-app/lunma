...
function installChrome(): void {
  ...
  (globalThis as unknown as { chrome: unknown }).chrome = {
    ...
    // Auto-archive (auto-archive): the boot registers the sweep alarm + its
    // listener synchronously in registerChromeListeners().
    alarms: { create: vi.fn(), onAlarm: { addListener } },
    windows: {
